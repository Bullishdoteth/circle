import { CreateCircleStep } from '@/types/circles';

interface CreateCircleStepIndicatorProps {
    currentStep: CreateCircleStep;
    onStepClick?: (step: CreateCircleStep) => void;
    canNavigateToStep2?: boolean;
}

export const CreateCircleStepIndicator: React.FC<CreateCircleStepIndicatorProps> = ({
    currentStep,
    onStepClick,
